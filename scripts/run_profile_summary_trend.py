from omegafx_v2.config import DEFAULT_PROFILE_USDJPY_TREND_M15_V1
from omegafx_v2.profile_summary import run_profile_summary


def main() -> None:
    profile = DEFAULT_PROFILE_USDJPY_TREND_M15_V1

    print(f"=== Strategy Profile (Trend): {profile.name} ===")
